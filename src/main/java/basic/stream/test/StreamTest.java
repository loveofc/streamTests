...
public class StreamTest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 확장자 확인 //
		String url=request.getServletContext().getRealPath("/WEB-INF/video/test.mp4");
		...
		try {
			...
			System.out.println("first"+partSize);
			do {
			...
			System.out.println("end"+partSize);
		} catch (IOException e) {
